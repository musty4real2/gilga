...
<legend><h3>REMOVE FROM STOCK</h3></legend>
...
if(isset($_POST['add'])){
	...
	if(!empty($error)){
		...
		header("location:remove.php?id=$id&table=$table");
			}
		}
	...
	//record the action
	$add="INSERT INTO `gilgal`.`removeinfo` (
`pid` ,
`table` ,
`qty` ,
`date` ,
...
$addin=mysql_query($add) or die("INSERT ERROR".mysql_error());
	...
	echo "<center><h1><img src='../images/ok.gif' width='68' height='62' />Product removed from stock!!!</h1></center>";
